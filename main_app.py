...
def main():
    ...
    if st.button("🔍 Search courses", type="primary", use_container_width=True):
        with st.spinner("🔄 Analyzing courses..."):
            ...
            results, search_info = search_courses(query, filters, emb, coll, bm25, data)
        ...
        log_search(
            ...
            used_llm_rerank=search_info['used_llm_rerank'],
            llm_rerank_failed=search_info['llm_rerank_failed'],
